...
SS3500 = {
  ...
  widthInput: function(width) {
      if (width == undefined || "") {  width = Number(document.getElementById("widthInput").value); }
      return SS3500.width = width;
   },
  heightInput: function(height) {
      if (height == undefined || "") { height = Number(document.getElementById("heightInput").value); }
      return SS3500.height = height;
   },
  verticalLitesInput: function(verticalLites) {
      ...
      return SS3500.verticalLites = verticalLites;
   },
  horizontalLitesInput: function(horizontalLites) {
      ...
      return SS3500.horizontalLites = horizontalLites;
   },
  ...
  MaxExceeded: function(Max_Number) {
    ...
    document.getElementById("PSF_Result_Div").innerHTML = "At this height the maximum width is " + Max_Number;
      
   },
TotalDimension: function() {
      return (SS3500.widthInput() + " x " + SS3500.heightInput() + " = " + (SS3500.widthInput() * SS3500.heightInput()/144).toFixed(2) + " Sqf");
  },
...
RetrieveInput: function (){
  ...
  return [width, height, verticalLites, horizontalLites];
 },
                                                                    ...
                                                                    if (width <= 24) { psf_M1 = psf_90_90_M1; }
                                                                    ...
                                                                    else if (height <= 114)              // At a Height of 114"
                                                                      {
                                                                      ...
                                                                      else if (height <= 120)              // At a Height of 120"
                                                                        {
                                                                            ...
                                                                            else if (width > 36) { psf_M1 = SS3500.this.MaxExceeded(36) + '\"' + " Steel Reinf needed to reach 60\""; }
                                                                        }
                                                                        else if (height <= 126)              // At a Height of 126"
                                                                          {
                                                                              ...
                                                                              else if (width > 36) { psf_M1 = SS3500.this.MaxExceeded(36)+ '\"' + " Steel Reinf needed to reach 54\""; }
                                                                          }
...
CalculatePSF: function (width, height, verticalLites, horizontalLites) {
    ...
    let widthperpanel = width / verticalLites - 1.75;
